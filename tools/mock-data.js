...
(function (root) {
  ...
  DATA.PARTS = [
    ...
    { id: 'storage-fdd-360k', name: '360KB 5.25" Floppy Drive', category: 'storage', removable: true,
      brand: 'Tandon',
    ...
    { id: 'storage-zip-100', name: 'Mock Zip 100 Drive', category: 'storage', brand: 'Iomega',
      removable: true, platformTags: ['STOR-IDE'], perf: { storageGB: 0.1, speed: 2 },
      reliability: 80, basePrice: 150, introYear: 1995, eolYear: 2003, tier: 'budget',
      powerDraw: 5, desc: 'Mock removable cartridge drive.' },
    { id: 'storage-fdd-144', name: 'Mock 1.44MB 3.5" Floppy', category: 'storage', brand: 'Teac',
      removable: true, platformTags: ['STOR-FDD'], perf: { storageGB: 0.00144, speed: 1 },
      reliability: 90, basePrice: 60, introYear: 1987, eolYear: 2002, tier: 'budget',
      powerDraw: 4, desc: 'Mock high-density floppy.' },
